    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, default='enter catchy bio', max_length=500, null=True)),
                ('user_icon', models.ImageField(blank=True, default='images/nerd.png', null=True, upload_to='images/')),
                ('country_code', django_countries.fields.CountryField(default='KE', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField()),
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='user_information', to='epa_frontend.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItems',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_of_stay', models.DateTimeField(default=datetime.datetime.now)),
                ('end_of_stay', models.DateTimeField(default=datetime.datetime.now)),
                ('event_id', models.ForeignKey(db_column='event_id', default=0, on_delete=django.db.models.deletion.CASCADE, related_name='event_details', to='epa_frontend.Events')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_details', to='epa_frontend.Orders')),
            ],
        ),
        migrations.CreateModel(
            name='Merchants',
            fields=[
                ...
                ('merchant_description', models.CharField(default='input merchant description', max_length=200)),
                ('country_code', django_countries.fields.CountryField(max_length=2)),
                ('created_at', models.DateTimeField(default=datetime.datetime.now)),
                ('admin_id', models.ForeignKey(db_column='admin_id', default=1, on_delete=django.db.models.deletion.CASCADE, related_name='user_profile', to='epa_frontend.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='EventsType',
            fields=[
                ...
                ('merchant_id', models.ForeignKey(db_column='merchant_id', on_delete=django.db.models.deletion.CASCADE, related_name='merchant_information', to='epa_frontend.Merchants')),
            ],
        ),
        migrations.AddField(
            model_name='events',
            name='event_type_id',
            field=models.ForeignKey(db_column='event_type_id', on_delete=django.db.models.deletion.CASCADE, related_name='event_type_information', to='epa_frontend.EventsType'),
        ),
        migrations.AddField(
            model_name='events',
            name='merchant_id',
