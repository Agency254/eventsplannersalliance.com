    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='merchant_information', to='epa_frontend.Merchants')),
            ],
        ),
        migrations.CreateModel(
            name='Properties',
            fields=[
                ...
                ('status', models.CharField(choices=[('booked', 'booked'), ('available', 'available')], max_length=50)),
                ('created_at', models.DateTimeField()),
                ('location', django_countries.fields.CountryField(max_length=2)),
                ('merchant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='merchant_details', to='epa_frontend.Merchants')),
                ('property_type_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='property_type_information', to='epa_frontend.PropertyType')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('user_icon', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('country_code', django_countries.fields.CountryField(max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField()),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_information', to='epa_frontend.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItems',
            fields=[
                ...
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_details', to='epa_frontend.Orders')),
                ('property_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='property_details', to='epa_frontend.Properties')),
            ],
        ),
        migrations.AddField(
            model_name='merchants',
            name='admin_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_profile', to='epa_frontend.Profile'),
        ),
    ]
